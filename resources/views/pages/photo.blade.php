        ...
        <div class="w-50 my-3 p-1 rounded shadow-lg">
            <div class="d-flex justify-content-between align-items-center">
                <a href="{{ route('profile.people', $data->user->id) }}"
                    ...
                    <span class="m-3 fs-5 text-dark">{{ $data->user->nama }}</span>
                </a>
                    ...
                    <li class="list-group-item border-start-0 border-end-0 d-flex flex-column">
                        <div class="d-flex justify-content-between align-items-center">
                            <a href="{{ route('profile.people', $comment->user->id) }}"
                                ...
                                <img src="{{ $data->user->avatar != null ? asset('storage/' . $data->user->avatar) : 'https://dummyimage.com/640x1:1/' }}"
                                    alt="profile-picture" width="50" height="50" 136
                            ...
                            <div class="d-flex align-items-center">
                                @if (Auth::user()->id == $comment->user->id)
                                    <svg data-bs-toggle="modal" data-bs-target="#editComment{{ $comment->id }}"
                                        ...
                                        <path
                                            d="M15.5021.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0- .121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 00 0 .196-.12l6.813-6.814z" />

                                        <path fill- rule="evenodd"
                                            d="M1 13.5A1.51.5 0 0 0 2.5 15h11a1.51.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5- .5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5z" />
                                    </svg>
